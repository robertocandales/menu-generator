    ...
    <>
      <Paper style={{ padding: '10px', width: '100%', height: '100%' }} elevation={4}>
        <Grid container direction='column' justify='center' alignItems='stretch' item>
          ...
          <Grid container direction='row' justify='space-between' alignItems='center' item sm={6}>
            <Grid item sm={3}>
              <FormControl fullWidth>
                <TextField
                  name='Price'
          ...
          <Grid container direction='row' justify='space-between' alignItems='center' item>
            <Grid item container direction='row' justify='space-between' alignItems='center' sm={6}>
              <Grid item sm={3}>
                <SelectComponent
                  name='category'
