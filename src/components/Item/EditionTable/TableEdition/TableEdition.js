...
import DataGrid from '../DataGridModal/DataGridModal';

function createData(Name, Price, Category, SubCategory, Digital, Take, Actions) {
  return { Name, Price, Category, SubCategory, Digital, Take, Actions };
}
...
const headCells = [
  { id: '1', numeric: false, disablePadding: false, label: 'Name' },
  { id: '2', numeric: true, disablePadding: false, label: 'Price' },
  { id: '3', numeric: true, disablePadding: false, label: 'Category' },
  { id: '4', numeric: true, disablePadding: false, label: 'Sub-category' },
  {
    id: '5',
    numeric: true,
  ...
  { id: '7', numeric: true, disablePadding: false, label: 'Actions' },
];
...
export default function TableEdition({ allItemsData }) {
