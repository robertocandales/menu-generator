...
const ListProductsModal = ({ allItemsData, setproductSelectedInDialog }) => {
  const defaultNames = [];
  ...
  React.useEffect(() => {
    const result = _.intersectionWith(allItemsData, checkedValues, (o, num) => o.id == num);
    setproductSelectedInDialog(result);
  }, [checkedValues]);
  return (
